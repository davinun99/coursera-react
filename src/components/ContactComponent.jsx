                        ...
                        <div className="col-12 col-md-9">
                            <Form onSubmit={this.handleSubmit}>
                                <FormGroup row>
                                    ...
                                    <Col md={10}>
                                        <Input onBlur={this.handleBlur('firstname')} 
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md={10}>
                                        <Input onBlur={this.handleBlur('lastname')} 
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md={10}>
                                        <Input onBlur={this.handleBlur('telnum')} 
                                            onChange={this.handleInputChange} type="tel" 
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md={10}>
                                        <Input onBlur={this.handleBlur('email')} 
                                            onChange={this.handleInputChange}
                                ...
                                <FormGroup row>
                                    ...
                                    <Col md={10}>
                                        <Input onChange={this.handleInputChange} type="textarea" rows="12" id="message" name="message" 
